...
def finetune_lizard(args):
    ...
    checkpoint_name = f"{args.model_type}/lizard_sam"

    # all the stuff we need for training
    train_loader = get_dataloaders(patch_shape=patch_shape, data_path=args.input_path, split='split1')
    val_loader = get_dataloaders(patch_shape=patch_shape, data_path=args.input_path, split='split2')
