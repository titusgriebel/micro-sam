...
>>>>>>> 46d2723 (Added path functions and monusac evaluation.)
    parser.add_argument("-e", "--experiment_folder", type=str, required=True) #empty directory for saving the output
    parser.add_argument("-o", "--organ_type", type=str, required=False, default=None) #optionally defines organ class to access. If empty, whole dataset is used
